...
public class UnBlacklistCommand extends BaseCommand {
    ...
    @Command(name = "unblacklist", inGameOnly = false, permission = "punishments.command.unblacklist", aliases = {"unbl", "unblplayer", "unblacklistplayer"})
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            ...
            if (!targetData.getPunishData().isBlacklisted()) {
                sender.sendMessage(PunishmentsLanguage.BLACKLIST_NOT_BLACKLISTED.toString().replace("<user>", target.getName()));
