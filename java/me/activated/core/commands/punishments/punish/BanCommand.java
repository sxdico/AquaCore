...
public class BanCommand extends BaseCommand {
    ...
    @Command(name = "ban", inGameOnly = false, permission = "punishments.command.ban", aliases = {"tempban"})
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(Color.translate("&cUsage: /ban <player> [optional:<duration>] <reason> [-s]"));
                return;
            }
