...
public class WarnCommand extends BaseCommand {
    ...
    @Command(name = "warn", permission = "punishments.command.warn", inGameOnly = false)
    public void onCommand(CommandArgs command) {
        ...
        Tasks.runAsync(plugin, () -> {
            if (args.length < 2) {
                sender.sendMessage(Color.translate("&cUsage: /warn <player> [optional:<duration>] <reason> [-s]"));
                return;
            }
            ...
            Punishment punishment = new Punishment(plugin, targetData, PunishmentType.WARN);
            ...
            if (sender instanceof Player) {
                ...
                PunishHistory punishHistory = new PunishHistory(sender.getName(), this.plugin, PunishmentType.WARN);
